...
import { toggleModal } from '../features/calendarSlice';
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] py-12 px-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Main Layout – Excellent whitespace + alignment */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          
          {/* Calendar – Large, breathing room */}
          <div className="lg:col-span-8">
            <CalendarGrid />
          </div>

          {/* Sidebar – Clear hierarchy + proximity */}
          <div className="lg:col-span-4 space-y-10">
            
            {/* Today’s Focus – Mirrors DayCell style */}
            <div className="bg-white rounded-3xl shadow-xl border border-zinc-100 p-8">
              ...
              <div className="bg-zinc-50 rounded-2xl p-6 min-h-40">
                {/* Dynamic content will go here via Redux */}
            ...
            {/* Motivational Quote – Improved contrast + whitespace */}
